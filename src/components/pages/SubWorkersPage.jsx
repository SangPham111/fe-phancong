...
const SubWorkersPage = () => {
  ...
  const fetchWorkers = async () => {
    try {
      const res = await getAssistantWorkers();
      setWorkers(res.data);
    } catch (error) {
      console.error('Lỗi khi lấy danh sách thợ phụ:', error);
    }
  };
  ...
  return (
    <div style={{ padding: 20 }}>
      ...
      <AddWorkerForm onSuccess={fetchWorkers} role="thợ phụ" />
      ...
      <Dialog open={editOpen} onClose={() => setEditOpen(false)}>
        <DialogTitle>Cập nhật thợ phụ</DialogTitle>
        <DialogContent>
